...
project = 'Gitlab-Sesyn'
copyright = '2023, Garvit Joshi'
author = 'Garvit Joshi'
...
htmlhelp_basename = 'gitlab-sesyn-docs'
...
latex_documents = [
    (master_doc, 'gitlabsesyn.tex', 'gitlabsesyn Documentation',
     'Garvit Joshi', 'manual'),
]
...
man_pages = [
    (master_doc, 'gitlabsesyn', 'gitlabsesyn Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'gitlabsesyn', 'gitlabsesyn Documentation',
     author, 'gitlabsesyn', 'Documentation to use gitlab server.',
     'Miscellaneous'),
]
